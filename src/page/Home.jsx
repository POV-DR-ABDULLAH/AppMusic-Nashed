  ...
  return (
    <div className="w-full h-screen bg-black flex">
      <div className="w-full md:w-[50%] h-full flex justify-start items-center pt-[20px] md:pt-[120px] flex-col gap-[30px]">
        <h1 className="text-white font-semibold text-[20px]">Sedang Diputar</h1>
        ...
        <div>
          <div className="text-white text-[30px] text-center" style={{ fontStyle: "italic"}}>
            {songsData[index].name}
          </div>
          <div className="text-gray-400 text-[17px] text-center">
